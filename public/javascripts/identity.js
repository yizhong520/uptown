...
//loads the user identity status
async function loadIdentity(){
    let identity_div = document.getElementById("identity_div");

    identity_div.innerHTML = "loading..."
    try{
        ...
        if(identityInfo.status == "loggedin"){
            ...
            <a href="/userAccount.html?user=${encodeURIComponent(identityInfo.userInfo.username)}">${escapeHTML(identityInfo.userInfo.name)} (${escapeHTML(identityInfo.userInfo.username)})</a>
